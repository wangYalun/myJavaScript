(function () {
  ...
  function millisecondToTime(micro_time) {
    ...
    var micro_s = parseInt(
      (micro_time - 60 * 1000 * minutes - 1000 * seconds) / 10
    );
  ...
  function millisecondsToString(milliseconds) {
    ...
    milliseconds =
      minutes > 0 ? milliseconds - minutes * oneMinute : milliseconds;
    ...
    milliseconds =
      seconds > 0 ? milliseconds - seconds * oneSecond : milliseconds;
